...
function Home() {
  ...
  return (
    ...
    <>
<main className="hero_img text-white flex  justify-center items-center text-center relative" >
    <div className="overflow-hidden">
      <h1 className={`${clicked && "fade_out_left"} text-[46px] font-bold uppercase  fade_in_left`}>
        Welcome to FastDeivery.
      </h1>
      <p className={`${clicked && "fade_out_right"} fade_in_right`}>Where Every Bite is an Experience</p>
      <button onClick={ handleOrder}  className={`${clicked&& "fade_out_bot"}  fade_in_up inline-block mt-4 relative h-[40px] w-[120px]  bg-[#C20303]`}>Order Now</button>
    </div>
    {clicked && <CreateUser clicked={clicked} />}
    {/* <CreateUser/> */}
    </main>
    {/* our story  */}
...
{/* testimonials */}
 <Testimonials />
 <section className="bg-[#FFF8EA]  flex items-center justify-center relative  ">
  <div className=" mx-auto grid grid-cols-2  justify-between items-center  	">
    <div className="p-[80px]  ">
      <h1 className="uppercase text-[32px] font-bold">Our <span className="text-[#C20303] uppercase">Story</span></h1>
      <p className="text-[16px] font-thin leading-tight">Who are in extremely love with eco friendly system. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
